...
export class StorageHelper {
    ...
    static createMissing(): void {
        ...
        if (this.storageDir !== this.store.get('client.dir')) {
            this.assetsDir = resolve(this.store.get('client.dir'), 'assets');
            this.librariesDir= resolve(this.store.get('client.dir'), 'libraries');
    ...
    static migration(path: string) {
        ...
        cpSync(this.librariesDir, resolve(path, 'libraries'), {recursive: true});
